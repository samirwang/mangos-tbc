...
enum LogFilters
{
    ...
    LOG_FILTER_PATHFINDING        = 0x004000,               // 16 Pathfinding
    LOG_FILTER_MAP_LOADING        = 0x008000,               // 17 Map loading/unloading (MAP, VMAPS, MMAP)
    LOG_FILTER_EVENT_AI_DEV       = 0x010000,               // 18 Event AI actions
};
